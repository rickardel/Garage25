...
namespace GoaGaraget.Controllers
{
    public class ReceiptsController : Controller
    {
        ...
        {
            var receipts = db.Receipts.Include(r => r.ParkedVehicle);
        ...
        {
            ViewBag.ParkedVehicleId = new SelectList(db.ParkedVehicles, "Id", "RegNumber");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,ParkedVehicleId,CheckinAt,CheckoutAt,Cost")] Receipt receipt)
        {
